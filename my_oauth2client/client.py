...
from my_oauth2client import _pkce
from my_oauth2client import clientsecrets
...
class GoogleCredentials(OAuth2Credentials):
    ...
    def from_json(cls, json_data):
        ...
        from my_oauth2client import service_account
        data = json.loads(_helpers._from_bytes(json_data))
...
def _get_application_default_credential_GAE():
    from my_oauth2client.contrib.appengine import AppAssertionCredentials

    return AppAssertionCredentials([])


def _get_application_default_credential_GCE():
    from my_oauth2client.contrib.gce import AppAssertionCredentials
...
def credentials_from_code(client_id, client_secret, scope, code,
                          ...
                          user_agent=None,
                          token_uri=my_oauth2client.GOOGLE_TOKEN_URI,
                          auth_uri=my_oauth2client.GOOGLE_AUTH_URI,
                          revoke_uri=my_oauth2client.GOOGLE_REVOKE_URI,
                          device_uri=my_oauth2client.GOOGLE_DEVICE_URI,
                          token_info_uri=my_oauth2client.GOOGLE_TOKEN_INFO_URI,
                          pkce=False,
                          code_verifier=None):
